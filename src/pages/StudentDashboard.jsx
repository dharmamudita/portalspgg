                  ...
                  <AnimatePresence>
                    {hasAllergyWarning && (
                      <motion.div
                        ...
                        className="bg-red-50 border border-red-200 rounded-xl p-3 flex items-start sm:items-center gap-3 overflow-hidden"
                      >
                        <TriangleAlert className="w-5 h-5 text-red-500 shrink-0 mt-0.5 sm:mt-0" />
                        <div className="flex-1">
                          <p className="text-sm text-red-800 font-medium leading-tight">
                            Perhatian: Menu ini mengandung <strong className="font-bold">{dangerousAllergens.join(', ')}</strong> (Alergi Anda).
                          </p>
                        </div>
                        <button className="px-3 py-1.5 bg-red-100 hover:bg-red-200 text-red-700 text-xs font-bold rounded-lg transition-colors shrink-0 border border-red-200">
                          Opsi Pengganti
                        </button>
                      </motion.div>
                    )}
